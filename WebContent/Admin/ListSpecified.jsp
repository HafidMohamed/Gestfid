...
<body>
	...
	<div class="content">
		...
		<div class="list-view">
			<div class="horizontal_form">
				<div class="row horizontal_row">
					<button class="btn-inline horizontal_btn active" onclick="list()"
			...
			<h2 class="list-title overview__heading">choose the major and
				the class to list the students</h2>
		...
		<div class="list-view__table" id="table">
			<table id="datatable" class="content-table" cellspacing="0"
				...
				<tbody>
					...
					<c:forEach items="${etudiantModel.classeEtudiants}" var="e">
						...
						<tr>
							<td><a class="idstudent-link"
								href="StudentProfile?IdEtudiant=${e.getIdEtudiant()}">${e.getIdEtudiantClasse()}</a></td>
							<td>${e.getNomEtudiant()}</td>
							<td>${e.getPrenomEtudiant()}</td>
							<td>${e.getCNI()}</td>
							<td>${e.getCNE()}</td>
							<td><a href="ModifyStudent?IdEtudiant=${e.getIdEtudiant()}">
									<button class="btn-table" data-title="Edit" data-toggle="modal"
										data-target="#edit">
							...
							<td><a
								href="DeleteStudentFromSpecifiedClass?IdEtudiant=${e.getIdEtudiant()}">
