				...
				<div class="inbox_msg">
								...
								<li class="chat">
									<div class="chat_list">
										<div class="chat_people">
											<a class="amessage"
												href="ConversationPp?id_from=${e.getId_user_from()}&id_to=${e.getId_user_to()}">
												<div class="chat_img">
					...
					<div class="mesgs" id="mesgs">
						<div class="msg_history">
							<ul>
								<c:forEach items="${etudiantModel.getConversationPage()}"
									var="e">
									<input type="hidden" id="id_from" value="${id_from}">
									<input type="hidden" id="id_to" value="${id_to}">
									<li><c:choose>
											<c:when test="${e.getMessageSend()==null}">
												<div class="incoming_msg">
													...
													<div class="received_msg">
														<div class="received_withd_msg">
															<p>${e.getMessageRecived()}</p>
															<span class="time_date"> ${e.getTime()} </span>
														</div>
													</div>
												</div>
											</c:when>
						...
						<div class="type_msg">
							<div class="input_msg_write">
								...
								<button class="msg_send_btn" id="SendMessage" type="button">
...
$('#SendMessage').on('click', function() {
	...
	$.ajax({
        ...
        success: function(responseText) {
            alert('Sending Message Successed');
