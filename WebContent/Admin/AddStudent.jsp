...
<title id="title-up">GestFid | Add</title>
</head>
<style>
.sidebar, .content {
	height: auto;
...
<body>
	...
	<div class="content">
				...
				<div class="horizontal_form">
					<div class="row horizontal_row">
						<a href="AddStudent1"><button
								class="btn-inline horizontal_btn active" id="AddEtudiant">Add
								a Student</button></a>
					</div>
					<div class="row horizontal_row">
					...
					<div class="row horizontal_row">
						<button class="btn-inline horizontal_btn" onclick="AddAbsences()"
							id="Addabsences">Add a Absences</button>
					</div>
				</div>
			</div>
			<div class="Add__form">
				<form name="f1" method="post" enctype="multipart/form-data"
					...
					<div class="form__group">
						<h1 class="heading-secondary" id="ast_h1">Adding a Student</h1>
					</div>
					<div class="form__group">
						<input type="text" class="form__input" placeholder=" Last Name"
							name="nom" id="nom" required> <label for="nom"
							class="form__label" id="student_nom">Student Last Name</label>
					</div>
					<div class="form__group">
						<input type="text" class="form__input" placeholder="First Name"
							name="prenom" id="prenom" required> <label for="prenom"
							class="form__label" id="student_prenom">Student First
							name</label>
					</div>
					<div class="form__group">
						<input type="text" class="form__input" placeholder="CNE"
							name="CNE" id="CNE" required> <label for="CNE"
							class="form__label" id="label_CNE">CNE</label>
					</div>
					<div class="form__group">
						<input type="text" class="form__input" placeholder="CNI"
							name="CNI" id="CNI" required> <label for="CNI"
							class="form__label" id="label_CNI">CNI</label>
					</div>
					<div class="form__group">
						<div class="row">
							<div class="row-col">
								<button type="button" class="account_btn" id="popup_account">Creat
									an account</button>
							</div>
							<div class="row-col">
								<div class="form">
									<div class="upload__file">
										<div class="file-upload-wrapper" data-text="Select your file!">
											<input name="photo" type="file" id="photo"
												class="file-upload-field input-file" value="">
						...
						<input type="hidden" id="date" value=getDateTime()>
					</div>
					<div class="form__group">
						<div class="row">
							<div class="row-col">
					...
					<div class="form__group">
						<button type="submit" class="btn btn__visible"
							id="AfterAddingStudent">Add Student</button>
					</div>
		...
		<div class="ppaccount">
			<div class="shaccount">
				<div class="inner_ppaccount">
					<div class="account_popup">
						<div class="title titl">
							<p class="para">Creating an account</p>
							<p class="close clos">
						...
						<div class="Add__form">
							<div class="form__group">
								<input type="email" class="form__input acc"
									placeholder="Email Address" name="email" id="email" required>
								<label for="email" class="form__label">Email Address</label>
							</div>
							<div class="form__group">
								<input type="password" class="form__input acc"
									placeholder="Password" data-type="password" name="password"
									id="password" required> <label for="password"
									class="form__label">Password</label>
							</div>
							<div class="form__group">
								<button type="submit" class="account_btn accc"
        ...
        $('#CreateAccount').on('click', function() {
    		...
    		$.ajax({
    	        ...
    	        success: function(responseText) {
    	            alert('Adding Account Success');
    	            $(".ppaccount").hide();
    	            document.getElementById("popup_account").innerHTML="&check;Account Created";
                    ...
                    myMain[0].innerHTML='<div class="Add">'+
                                		...
                                		'</div>'+
                                                ...
                                                '<div class="row-col" >'+
                                                 ...
                                                 '<div class="custom-select">'+
                                                   '<select class="select-css" id="semesters" name="semester">'+
