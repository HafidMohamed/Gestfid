...
<title>GestFid | Informations</title>
</head>
<body>
	<header class="header">
	<div class="navbar">
	...
	<div class="content">
		...
		<div class="legal" id="legal">&copy; 2020 by GestFid. All rights
			reserved</div>
		</nav>
		<main class="Amin-view">

		<div class="wrapper">
			<div class="left">
				<img
					src="data:image/jpg;base64,${etudiantModel.etudiant.getBase64image()}"
					alt="user" width="100">
			...
			<div class="right">
				<div class="info">
					...
					<div class="info_data">
						<div class="data">
							<h4 id="nom">Last Name</h4>
							<p>${etudiantModel.etudiant.getNomEtudiant()}</p>
						</div>
						<div class="data">
							<h4 id="prenom">First Name</h4>
		...
		<div class="arrow">
			<div class="u-center-text u-margin-top-huge">
				<a href="Home" class="btn-text" id="back_home">&larr; Back to
					Home</a>
			</div>
		</div>
		</main>
