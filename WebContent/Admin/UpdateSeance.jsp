...
<title id="title-up">GestFid | Edit Seance</title>
</head>
<body>
	<header class="header">
	<div class="navbar">
	...
	<div class="content">
		...
		<div class="Add">
			<div class="Add__form">
				<input type="hidden" name="IdSeance" id="IdSeance"
					value="${etudiantModel.seance.getIdSeance()}" />
				<div class="form__group">
					<h1 class="heading-secondary" id="mms_h1">Modifying a Session
					</h1>
				</div>
				<div class="form__group">
					<input type="date" class="form__input" placeholder="Session Date"
						name="DateSeance" id="DateSeance"
						value="${etudiantModel.seance.getDateSeance()}" required>
					<label for="DateSeance" class="form__label" id="Session_label">Session
						Date</label>
				</div>
				<div class="form__group">
					<input type="time" class="form__input"
						placeholder="Session Begin Time" name="HeureDebut" id="HeureDebut"
						value="${etudiantModel.seance.getHeureDebut()}" required>
					<label for="HeureDebut" class="form__label"
						id="Session-begin_label">Session Begin Time</label>
				</div>
				<div class="form__group">
					<input type="time" class="form__input"
						placeholder="Session End Time" name="HeureFin" id="HeureFin"
						value="${etudiantModel.seance.getHeureFin()}" required> <label
						for="HeureFin" class="form__label" id="Session-end_label">Session
						End Time</label>
				</div>
				<div class="form__group">
					<input type="text" class="form__input" placeholder="Session Type"
						name="TypeSeance" id="TypeSeance"
						value="${etudiantModel.seance.getTypeSeance()}" required>
					<label for="TypeSeance" class="form__label" id="Session-type">Session
						Type</label>
				</div>
				<div class="form__group">
					<div class="row">
						<div class="row-col">
							...
							<div class="custom-select">
								<select class="select-css select" id="IdModule" name="IdModule">
									<option data-id="${etudiantModel.seance.getIdModule()}"
										selected>${etudiantModel.seance.getModuleLibelle()}</option>
				...
				<div class="form__group">
					<button type="submit" class="btn btn__visible"
						id="AfterModifyingSession">Modify Session</button>
				</div>
	...
	<script type="text/javascript">
        $("#AfterModifyingSession").on("click",function() {
        	var IdSeance=$('#IdSeance').val();
    	    ...
    	    $.ajax({
    	        ...
    	        success: function(responseText) {
    	            ...
    	            alert('Modifying Session Success');
                    
    	        },
    	        failure: function(responseText) {
    	            alert('Modifying Session Failed');
    	        }
    	    });
    	});
$("#AfterAddingStudent").on("click",function() {
    	    ...
    	    $.ajax({
    	        ...
    	        success: function(responseText) {
    	        	...
    	        	document.getElementById("popup_account").innerHTML="Create account";
