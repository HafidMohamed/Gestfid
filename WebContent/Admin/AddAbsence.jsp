...
<title>GestFid | Add Absence</title>
</head>
<body>
	<header class="header">
	<div class="navbar">
	...
	<div class="content">
		...
		<div id="icon-layout">
			<ul class="sid-nav">
				...
				<li class="side-nav__item" id="list-1"><a href="List"
					onclick="ListForm()" class="side-nav__link"> <svg
							class="side-nav__icon"> <use
				...
				<li class="side-nav__item" id="list-2"><a href="Add"
					onclick="Add()" class="side-nav__link li-active"> <svg
							class="side-nav__icon"> <use
		...
		<div class="Add__form">
			<div class="horizontal_form">
				<div class="row horizontal_row">
					<a href="AddStudent1"><button
							class="btn-inline horizontal_btn " id="AddEtudiant">Add
							a Student</button></a>
				</div>
				<div class="row horizontal_row">
					<button class="btn-inline horizontal_btn " onclick="AddModule()"
						id="AddModule">Add a Module</button>
				</div>
				<div class="row horizontal_row">
					<button class="btn-inline horizontal_btn" onclick="AddClasse()"
						id="Addclasse">Add a Class</button>
				</div>
				<div class="row horizontal_row">
					<button class="btn-inline horizontal_btn" onclick="AddTeatcher()"
						id="Addteacher">Add a teacher</button>
				</div>
				<div class="row horizontal_row">
					<button class="btn-inline horizontal_btn" onclick="AddFiliere()"
						id="Addfiliere">Add a Major</button>
				</div>
				<div class="row horizontal_row">
					<button class="btn-inline horizontal_btn " onclick="AddSession()"
						id="AddSession">Add a Session</button>
				</div>
				<div class="row horizontal_row">
					<button class="btn-inline horizontal_btn active"
						onclick="AddAbsences()" id="Addabsences">Add a Absences</button>
				</div>
			</div>
		</div>
		<div class="list-view">
			<h2 class="list-title overview__heading" id="aa_h2">choose the
				major and the class to list the students</h2>
			<form method="POST" action="ListAbsences">
				<div class="row">
					<div class="row-col">
						<input type="date" class="form__input" placeholder="Session Date"
							name="DateSeance" id="DateSeance" required=""> <label
							for="DateSeance" class="form__label" id="Session_label">Session
							Date</label>
					</div>
					<div class="row-col">
						<input type="time" class="form__input"
							placeholder="Session Begin Time" name="HeureDebut"
							id="HeureDebut" required=""> <label for="HeureDebut"
							class="form__label" id="Session-begin_label">Session
							Begin Time</label>
					</div>
					<div class="row-col">
						<input type="time" class="form__input"
							placeholder="Session End Time" name="HeureFin" id="HeureFin"
							required=""> <label for="HeureFin" class="form__label"
							id="Session-end_label">Session End Time</label>
					</div>
				</div>
				<div class="row">
					<div class="row-col">
					...
					<div class="list-form">
						<div class="form__group">
							<h1 class="heading-secondary Table-header" id="daa_h1">
								Displaying Sessions Informations</h1>
						</div>
						<div class="form__group">
							<div class="list-view__table-one">
								<table id="datatableSeance" class="content-table"
									...
									<tbody>
										...
										<c:forEach items="${etudiantModel.seances}" var="e">
											...
											<tr>
												<td class="idseance" data-id="${e.getIdSeance()}">${e.getModuleLibelle()}</td>
					...
					<div class="list-form">
						<div class="form__group">
							<h1 class="heading-secondary Table-header" id="daal_h1">
								Displaying Students Informations</h1>
						</div>
						<div class="form__group">
							<div class="list-view__table-tow">
								<table id="datatable" class="content-table" cellspacing="0"
									...
									<thead>
										<tr>
											<th id="t-idEtudiant">IdEtudiant</th>
											...
											<tr>
												...
												<td>
													<div class="Selectbutton">
														<a
															href="javascript:void(0)?IdEtudiant=${e.getIdEtudiant()}">
															<button class="btn-table" data-title="Delete" id="idetud"
																data-id="${e.getIdEtudiant()}" data-toggle="modal"
																data-target="#delete">
																<svg class="icon-table-blue"> <use
																	xlink:href="img/sprite.svg#icon-user-check"></use> </svg>
															</button>
														</a>
													</div>
												</td>
		...
		<div class="ppabsence">
			<div class="shabsence"></div>
			<div class="inner_ppabsence">
				<div class="Absence_popup">
					<ul>
						<li class="title">
							<p id="Addabsences">Adding Absence</p>
							<p class="close">
								<i class="fas fa-times" aria-hidden="true"></i>
							</p>
						</li>
						<li>
							<div class="title-sec" id="t-justify">justify?</div>
							<div class="form__radio-group ">
								<input type="radio" class="form__radio-input justify" id="small"
									value="1" name="justify"> <label for="small"
									class="form__radio-label"><span
									class="form__radio-button"></span></label> <label for="small"
									class="form__radio-label scond" id="yes"> Yes </label>

							</div>
						</li>
						<li class="line">
							<div class="form__radio-group ">
								<input type="radio" class="form__radio-input justify" id="large"
									value="0" name="justify"> <label for="large"
									class="form__radio-label"><span
									class="form__radio-button"></span></label> <label for="large"
									class="form__radio-label scond" id="no"> NO </label>
							</div>

						</li>
						<li class="line">
							<div class="form__group">
								<label for="comment" class="form__radio-label label"
									id="absenceComment">Comment For Abcense:</label><br>
						...
						<li>
							<div class="form__group btn-absence">
								<button type="submit" class="btn btn__visible " id="AddAbsence">Add
									Absence</button>
							</div>
...
$(document).ready(function() {
	$('.btn-table').on('click', function() {
		IdEtudiant=$(this).data('id');
		IdSeance=$('.idseance').attr('data-id');
		alert(IdEtudiant);
		alert(IdSeance);
	});
});
            ...
            var justify = $(".justify:checked").val();
    		$.ajax({
    	        ...
    	        success: function(responseText) {
    	            alert('Adding Absence Success');
    	            
    	            
    	        },
    	        failure: function(responseText) {
    	            alert('Adding Absence Failed');
    	        }
    	    });
    		});
