...
<title>GestFid | Update Students</title>
</head>
<body>
	<header class="header">
	<div class="navbar">
			...
			<ul class="sid-nav">
				...
				<li class="side-nav__item" id="list-2"><a href="Add"
					onclick="Add()" class="side-nav__link li-active"> <svg
						...
						class="side-nav__link-text li-active" id="add">Add</span>
				</a></li>
			...
			<div class="Add__form">
				<form method="POST" action="UpdateStudent">
					<input type="hidden" name="id"
						value="${etudiantModel.etudiant.getIdEtudiant()}" />
					<div class="form__group">
						<h1 class="heading-secondary" id="mst_h1">Modifying a Student
						</h1>
					</div>
					<div class="form__group">
						<input type="text" class="form__input" placeholder="Student Name"
							name="nom" id="nom"
							value="${etudiantModel.etudiant.getNomEtudiant()}" required>
						<label for="nom" class="form__label" id="student_nom">Student
							Name</label>
					</div>
					<div class="form__group">
						<input type="text" class="form__input"
							placeholder="Student first name" name="prenom" id="prenom"
							value="${etudiantModel.etudiant.getPrenomEtudiant()}" required>
						<label for="prenom" class="form__label" id="student_prenom">Student
							first name</label>
					</div>
					<div class="form__group">
						<input type="text" class="form__input" placeholder="CNE"
							name="CNE" id="CNE" value="${etudiantModel.etudiant.getCNE()}"
							required> <label for="CNE" class="form__label"
							id="label_CNE">CNE</label>
					</div>
					<div class="form__group">
						<input type="text" class="form__input" placeholder="CNI"
							name="CNI" id="CNI" value="${etudiantModel.etudiant.getCNI()}"
							required> <label for="CNI" class="form__label"
							id="label_CNI">CNI</label>
					</div>
					<div class="form__group">
						<div class="row">
							...
							<div class="row-col">
								...
								<div class="custom-select">
									...
									<select class="select-css" id="filiere" name="filiere"
										value="${etudiantModel.etudiant.getFiliere()}">
							...
							<div class="row-col">
								...
								<div class="custom-select">
									<select class="select-css" id="classe" name="classe"
										value="${etudiantModel.etudiant.getClasse()}">
						...
						<div class="form__group">
							<button type="submit" class="btn btn__visible"
								id="AfterModifyingStudent">Modify Student</button>
						</div>
