...
<title>GestFid | Specified Lists</title>
</head>
<body>
	<header class="header">
	<div class="navbar">
	...
	<div class="content">
		...
		<div class="list-view">
			<div class="horizontal_form">
				...
				<div class="row horizontal_row">
					<button class="btn-inline horizontal_btn"
						onclick="displaySpecifiedAbsences()" id="DisplaySpecifiedAbsences">Display
						Specified Absences</button>
				</div>
			</div>
			<h2 class="list-title overview__heading" id="h2_doa">The
				Displaying of the Absences by specified Class</h2>
		...
		<div class="list-view__table" id="table-view">

			<div class="list">
				<div class="list-form">
					<div class="form__group">
						<h1 class="list-title overview__heading" id="dab_h1">Absence
							Class</h1>
					</div>
					<div class="form__group">
						<div id="hide">
							...
							<label class="form__label"
								style="font-size: 17px; font-weight: 600;">Filiere :
								${filiere}</label> <label class="form__label"
								style="font-size: 17px; font-weight: 600;">Classe :
								${classe}</label> <label class="form__label"
								style="font-size: 17px; font-weight: 600;">Classe :
								${semester}</label>
						</div>
					</div>
						...
						<div class="list-view__table">
							<table id="datatable" class="content-table" cellspacing="0"
								...
								<tbody>
									...
									<c:forEach items="${etudiantModel.list}" var="first"
										varStatus="status">
										<tr>

											<td>${etudiantModel.getClasseEtudiants().get(status.index).getNomEtudiant()}
												${etudiantModel.getClasseEtudiants().get(status.index).getPrenomEtudiant()}</td>
											<c:forEach var="e" items="${first}">
