...
<title id="title-up">GestFid | List</title>
</head>
...
.sidebar, .content {
		...
		<div class="Add">
			<div class="Add__form">
				<div class="form__group">
					<h1 class="heading-secondary" id="a_h1">Select Operation
						Please!</h1>
				</div>
				<div class="horizontal_form">
					<div class="row horizontal_row">
						<button class="btn-inline horizontal_btn" onclick="list()"
							id="DisplaySpecifiedClasse">Display specified Classe</button>
					</div>
					<div class="row horizontal_row">
						<button class="btn-inline horizontal_btn"
							onclick="displayAllStudents()" id="Displaystudents">Display
							All Students</button>
					</div>
					<div class="row horizontal_row">
						<button class="btn-inline horizontal_btn"
							onclick="displayAllSessions()" id="DisplaySessions">Display
							Sessions</button>
					</div>
					<div class="row horizontal_row">
						<button class="btn-inline horizontal_btn"
							onclick="displayAllAbsences()" id="DisplayAbsences">Display
							Absences</button>
					</div>
					<div class="row horizontal_row">
						<button class="btn-inline horizontal_btn"
							onclick="displayAllAbsencesSpecified()" id="DisplayAbsences">Display
							Absences for Specified Class</button>
					</div>
					<div class="row horizontal_row">
						<button class="btn-inline horizontal_btn"
							onclick="displaySpecifiedAbsences()"
							id="DisplaySpecifiedAbsences">Display Specified Absences</button>
					</div>
				</div>
	...
	<script type="text/javascript">
        ...
        function ListForm(){
        	...
        	'</div>'+
        	'<div class="row horizontal_row">'+
            '<button class="btn-inline horizontal_btn" onclick="displayAllAbsencesSpecified()" id="DisplayAbsences">Display Absences for Specified Class</button>'+
        	'</div>'+
        	'<div class="row horizontal_row">'+
        ...
        '</div>'+
                        ...
                        '</div>'+
                    '</div>'+
                    '<style>.sidebar,.content{height: 100%; }</style>';
            let obj=new Translate();
            let translate = obj.translate(localStorage.getItem("Language"));
            translate(); // l'objet global
        ...
        function displayAllSessions(){
            ...
            '</div>'+
                            ...
                            '</div>'+
                            '</div>'+
                        '</div>'+'<style>.sidebar,.content{height: 100%; }</style>';
                let obj=new Translate();
                let translate = obj.translate(localStorage.getItem("Language"));
                translate(); // l'objet global
            }
        ...
        function displayAllAbsencesSpecified(){
            document.title ="GestFid | Lists" ;
            myMain[0].innerHTML='<div class="list-view">'+
                            '<div class="horizontal_form">'+
                                        '<div class="row horizontal_row">'+
                                        ...
                                        '</div>'+
                                        '<div class="row horizontal_row">'+
                                            '<button class="btn-inline horizontal_btn active" onclick="displayAllAbsencesSpecified()" id="DisplayAbsences">Display Absences for Specified Class</button>'+
                                        '</div>'+
                                        '<div class="row horizontal_row">'+
                                            '<button class="btn-inline horizontal_btn" onclick="displaySpecifiedAbsences()" id="DisplaySpecifiedAbsences">Display Specified Absences</button>'+
                                        '</div>'+
                                    '</div>'+
                                    '<h2 class="list-title overview__heading" id="h2_doa">The Displaying of the Absences by specified Class</h2>'+
                    '<form method="POST" action="DisplaySpecifiedClassAbsence">'+
                '<div class="row">'+
                    '<div class="row-col">'+
               ...
               '</div>'+
                ...
                '<div class="row">'+
                   ...
                   '<div class="row">'+
                       '<div class="row-col">'+
                           '<div class="form__group">'+
                               '<input type="date" class="form__input" placeholder="Session Date" name="FromDate" id="FromDate" >'+
                               '<label for="FromDate" class="form__label" id="FromDate_label">From date:</label>'+
                           '</div>'+
                       '</div>'+
                       '<div class="row-col">'+
                           '<div class="form__group">'+
                               '<input type="date" class="form__input" placeholder="Session Date" name="ToDate" id="ToDate" >'+
                               '<label for="FromDate" class="form__label" id="ToDate_label">To date:</label>'+
                           '</div>'+
                       '</div>'+
                       '<div class="row-col" >'+
