...
<body>
	...
	<div class="content">
		...
		<div class="list-view typebottom">
			...
			<form method="POST" action="DisplayAbsenceType">
				<div class="row">
					<div class="row-col">
						...
						<div class="row-col">
							<div class="form__group">
								<input type="date" class="form__input"
									placeholder="Session Date" name="FromDate" id="FromDate">
								<label for="FromDate" class="form__label" id="FromDate_label">From
									date:</label>
							</div>
						</div>
						<div class="row-col">
							<div class="form__group">
								<input type="date" class="form__input"
									placeholder="Session Date" name="ToDate" id="ToDate"> <label
									for="FromDate" class="form__label" id="ToDate_label">To
									date:</label>
							</div>
						</div>
						<div class="row-col">
