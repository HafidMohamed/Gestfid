...
<title>GestFid | All Students</title>
</head>
<body>
	<header class="header">
	<div class="navbar">
		...
		<div class="list">
			<div class="list-form">
				<div class="form__group">
					<h1 class="heading-secondary" id="daal_h1">Displaying Students
						Information</h1>
				</div>
				<div class="form__group">
						...
						<table id="datatable" class="content-table" cellspacing="0"
							...
							<thead>
								<tr>
									...
									<th id="t-NomEtudiant">Last Name</th>
									<th id="t-PrenomEtudiant">First Name</th>
									<th>CNI</th>
									<th>CNE</th>
								...
								<c:forEach items="${etudiantModel.listEtudiants}" var="e">
									...
									<tr>
										<td><a class="idstudent-link"
											href="StudentProfile?IdEtudiant=${e.getIdEtudiant()}">${e.getIdEtudiant()}</a></td>
										...
										<td>${e.getClasse()}</td>
										<td><a
											href="ModifyStudent?IdEtudiant=${e.getIdEtudiant()}">
										...
										<td><a
											href="DeleteStudent?IdEtudiant=${e.getIdEtudiant()}">
			...
			<div class="list-form" id="table-view">
				<div class="form__group">
					<h1 class="heading-secondary" id="daal_h1">Displaying Students
						Information</h1>
				</div>
				<div class="form__group" id="hide">
					<div class="list-view__table">
						<table id="datatable" class="content-table" cellspacing="0"
							width="100%">
							<thead>
